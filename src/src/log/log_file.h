...
*/
typedef struct _cfg_log_file_t {
	CFG_COMMON_PART(log_file);
	char *file;			// name of the logfile
...
*/
#define L2F_LOG_FILE_DEFAULT_FILE	"/var/log/listen2fritz.log"
#define L2F_LOG_FILE_DEFAULT_FORMAT	"%W;%T;%P;%l;%D;%c;%a\n"
